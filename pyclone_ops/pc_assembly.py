...
class pc_assembly_OT_create_new_cage(Operator):
    ...
    def execute(self, context):
        ...
        cage.dim_x(value=pc_unit.millimeter(600))
        cage.dim_y(value=pc_unit.millimeter(600))
        cage.dim_z(value=pc_unit.millimeter(600))
...
class pc_assembly_OT_add_object(Operator):
    ...
    def add_object_to_cage(self,context,cage):
        ...
        if self.object_type == 'GEONODE_PART':
            ...
            obj.set_input("Thickness",pc_unit.millimeter(18))
