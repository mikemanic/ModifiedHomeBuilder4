...
class PC_Scene_Props(PropertyGroup):
    ...
    arrow_length: FloatProperty(name="Arrow Length",default=pc_unit.millimeter(30),subtype='DISTANCE',update=update_dimension_info)

    arrow_height: FloatProperty(name="Arrow Height",default=pc_unit.millimeter(30),subtype='DISTANCE',update=update_dimension_info)

    line_thickness: FloatProperty(name="Line Thickness",default=pc_unit.millimeter(2),subtype='DISTANCE',update=update_dimension_info)
