...
wall = add_wall((0,0,0),pc_unit.millimeter(3000),pc_unit.millimeter(2450),pc_unit.millimeter(150))
create_window(wall,location=(pc_unit.millimeter(254),pc_unit.millimeter(1100)),size=(pc_unit.millimeter(600),pc_unit.millimeter(600)),window_id='Standard Window')
create_door(wall,location=pc_unit.millimeter(1275),size=(pc_unit.millimeter(900),pc_unit.millimeter(2200)),door_id='Standard Door')