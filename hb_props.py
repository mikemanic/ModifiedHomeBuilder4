...
class Home_Builder_Scene_Props(PropertyGroup):  
    ...
    wall_height: FloatProperty(name="Wall Height",default=pc_unit.millimeter(2500),subtype='DISTANCE')
    wall_thickness: FloatProperty(name="Wall Thickness",default=pc_unit.millimeter(150),subtype='DISTANCE')

    wall_distance_snap_value: FloatProperty(name="Wall Distance Snap Value",default=pc_unit.millimeter(500),subtype='DISTANCE')
