...
class home_builder_OT_place_door_window(pc_snap.Drop_Operator):
    ...
    def refresh_data(self,hide=True):
        ...
        self.assembly.obj_x. empty_display_size = pc_unit.millimeter(1)
        self.assembly.obj_y. empty_display_size = pc_unit.millimeter(1)
        self.assembly.obj_z. empty_display_size = pc_unit.millimeter(1)
