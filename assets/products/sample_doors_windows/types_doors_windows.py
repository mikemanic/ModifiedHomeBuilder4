...
class Hole(pc_types.Assembly):
    ...
    def draw(self):
        ...
        self.obj_x.location.x = pc_unit.millimeter(3000) #Length
        self.obj_y.location.y = pc_unit.millimeter(100)   #Depth
        self.obj_z.location.z = pc_unit.millimeter(50)   #Thickness
...
class Door(pc_types.Assembly):
    ...
    width = pc_unit.millimeter(900)
    height = pc_unit.millimeter(1800)
    depth = pc_unit.millimeter(150)
    ...
    def add_door_handle(self,door_panel,door_handle_category="",door_handle_name=""):
        ...
        door_handle_center. empty_display_size = pc_unit.millimeter(1)
...
class Swing_Door(Door):
    ...
    def draw_assembly(self):
        ...
        self.add_prompt("Door Reveal",'DISTANCE',pc_unit.millimeter(3))
        self.add_prompt("Door Frame Width",'DISTANCE',pc_unit.inch(3))
        self.add_prompt("Door Frame Reveal",'DISTANCE',pc_unit.millimeter(3))
        self.add_prompt("Handle Vertical Location",'DISTANCE',pc_unit.millimeter(900))
...
class Standard_Window(pc_types.Assembly):
    ...
    width = pc_unit.millimeter(900)
    height = pc_unit.millimeter(1100)
    depth = pc_unit.millimeter(150)
    z_loc = pc_unit.millimeter(1)
    ...
    def draw_assembly(self):
        ...
        self.add_prompt("X Offset",'DISTANCE',pc_unit.millimeter(254))
