...
def add_base_design_carcass(assembly,exposed_interior=False):
    """Load the Base-specific carcass part (Base Carcass.blend).

    This mirrors add_design_carcass but loads the Base Carcass file which
    can contain different geometry/prompt setup specifically for base units.
    """
