...
class Closet_Starter(Closet):
    ...
    def add_system_holes(self,index,left_panel,right_panel):
        ...
        holes.loc_z('IF(remove_bottom, 0, kick_height + p_thickness)',[floor,p_height,opening_height, kick_height, p_thickness, remove_bottom])
        holes.rot_x(value = 0)
        holes.rot_y(value = 0)
        holes.rot_z(value = 0)
        holes.dim_x('opening_width',[opening_width])
        holes.dim_y('opening_depth',[opening_depth])
        holes.dim_z('opening_height',[opening_height, kick_height, p_thickness, remove_bottom])
