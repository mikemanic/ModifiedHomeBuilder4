...
def add_blind_cabinet_prompts(assembly):
    ...
    assembly.add_prompt("Blind Panel Reveal",'DISTANCE',pc_unit.millimeter(22))  
...
def add_base_assembly_prompts(assembly):
    ...
    assembly.add_prompt("Boolean Overhang",'DISTANCE',pc_unit.millimeter(30))  
...
def add_cabinet_lighting_prompts(assembly):
    ...
    assembly.add_prompt("Lighting Width",'DISTANCE',pc_unit.millimeter(20)) 
    assembly.add_prompt("Lighting Dim From Front",'DISTANCE',pc_unit.millimeter(30)) 
    assembly.add_prompt("Lighting Inset From Sides",'DISTANCE',pc_unit.millimeter(20)) 

def add_splitter_prompts(assembly):
    props = utils_cabinet.get_scene_props(bpy.context.scene)
    assembly.add_prompt("Thickness",'DISTANCE',props.closet_shelf_thickness)
    assembly.add_prompt("Left Thickness",'DISTANCE',pc_unit.millimeter(18))
    assembly.add_prompt("Right Thickness",'DISTANCE',pc_unit.millimeter(18))
    assembly.add_prompt("Top Thickness",'DISTANCE',pc_unit.millimeter(18))
    assembly.add_prompt("Bottom Thickness",'DISTANCE',pc_unit.millimeter(18))
    assembly.add_prompt("Extend Top Amount",'DISTANCE',pc_unit.millimeter(0))
    assembly.add_prompt("Extend Bottom Amount",'DISTANCE',pc_unit.millimeter(0))
