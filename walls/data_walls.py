...
#         material_thickness = self.add_prompt("Material Thickness",'DISTANCE',pc_unit.millimeter(50))
...
#         mortar_inset = self.add_prompt("Mortar Inset",'DISTANCE',pc_unit.millimeter(3))
...
#         #Set Default Dimensions
#         self.obj_x.location.x = pc_unit.millimeter(3000) #Length
#         self.obj_y.location.y = pc_unit.millimeter(3000) #Depth
#         self.obj_z.location.z = props.wall_height
