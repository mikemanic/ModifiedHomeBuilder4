...
class home_builder_OT_draw_multiple_walls(pc_snap.Drop_Operator):
    ...
    def create_wall(self):
        ...
        self.dim.set_input("Offset Text Amount",pc_unit.millimeter(150))
    ...
    def position_object(self,selected_point,selected_obj,set_angle,use_snap):
        if self.starting_point == ():
            ...
            if self.current_wall.obj_x.location.x < pc_unit.millimeter(500):
...
class home_builder_OT_draw_floor_plane(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        smallest_x = 0
        smallest_y = 0
        overhang = pc_unit.millimeter(150)
        wall_assemblies = []
        wall_bps = []
...
class home_builder_OT_add_room_light(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        obj_lamp.data.size = length + pc_unit.millimeter(500)
        obj_lamp.data.size_y = math.fabs(width) + pc_unit.millimeter(500)
...
class home_builder_OT_add_wall_snap_line(pc_snap.Drop_Operator):
    ...
    def create_dims(self,context):
        ...
        self.center_dim.set_input("Leader Length",pc_unit.millimeter(1))
